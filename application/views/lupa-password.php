                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">Masukkan email Anda, kemudian kami akan mengirimkan link untuk mengatur ulang password.</p>
                                    </div>
                                    <form class="user">
                                        ...
                                        <a href="<?= base_url('assets/sbadmin2/'); ?>login.html" class="btn btn-primary btn-user btn-block">
                                            Reset Password
                                        </a>
                                    </form>
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="<?= base_url('assets/sbadmin2/'); ?>login.html">Login disini</a>
                                    </div>
                                </div>
                            </div>
                        </div>
