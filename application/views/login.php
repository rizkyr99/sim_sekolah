                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" action="login" method="POST">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="nis" aria-describedby="emailHelp" placeholder="Masukkan NIS" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <hr>
                                        <a href="<?= base_url('login/pegawai'); ?>" class="btn btn-outline-primary btn-user btn-block">Login sebagai Guru atau Pegawai
                                        </a>
                                    </form>
                                    <hr>
                                    <div class="text-center">
